...
<video width={props.width || 700} controls>
  <source src="/videos/part-flag.mp4" type="video/mp4" />
  Your browser does not support the video tag.
</video>

<Steps>
<Step>
Create a single choice question as described [here](/docs/survey-editor/guides/add-single-choice). In our example the title text is *"Are you currently pregnant or think you might be pregnant?"* with options *"yes"* and *"no"*.
</Step>
<Step>
...
![Window with survey context variables](../images/surveyContext1.png)
</Step>
<Step>
...
![Survey simulator with pregnancy question and gender participant flag](../images/surveyContext2.png)
</Step>
</Steps>

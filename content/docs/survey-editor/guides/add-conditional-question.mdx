...
In the dropdown menu, scroll to the Templates section and select **“Consent question accepted”**.
  ...
  <Step>
  A response slot key is not required. Use the survey [simulator](/docs/survey-editor/basics/simulator#simulator) to verify that the conditional logic works as expected.
</Step>
</Steps>

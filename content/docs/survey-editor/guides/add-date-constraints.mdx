...
<Step> 
Under **Latest**, set the maximum possible date. - Choose **Get timestamp**. - Keep the **Offset** at *0 days*, so that the latest valid date is today. This ensures that participants cannot select a date in the future.
</Step> 
<Step>
...
<Step> 
In the **Earliest** field, click **+ add value** and select **"Get response value as number".
</Step>
<Step> 

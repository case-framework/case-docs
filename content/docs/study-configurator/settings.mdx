...
<Callout type="info">
To trigger a message topic, you need to explicitly add this into the study rules.
</Callout>

### Managing Notification Subscriptions

Each notification topic shows:
- **Topic name**: The identifier for the notification topic (e.g., "topic1")
...
![New Topic Subscription](./images/notifications2.png)

In the "New topic subscription" dialog:

1. **Message type**: Select the type of notification (e.g., "reminder")
...
2. **Action**: Select the action that this user is allowed to perform on the study

...
<Callout type="info">
To trigger a message topic, you need to use the [Notify researchers (Email)](/docs/study-rules-editor/basics/study-rules#6-notify-researchers-email) action in the Study Rules Editor when defining event handlers.
</Callout>

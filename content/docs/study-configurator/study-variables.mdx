...
Study variables allow study administrators to dynamically steer the behavior of the study system, without needing to change the study rules or questionnaires.

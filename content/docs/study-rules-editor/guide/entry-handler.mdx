...
Choose the message type *"Welcome"* you defined in your survey context. 
 ...
 Add another action by clicking **"+ add value"** and select **"Add new survey"**. 
  ...
  Select the survey key *"intake"*. Add **"Get timestamp"** for **"Available from"** and keep the offset to *0 days* (current timestamp). Leave **"Available until"** empty if the survey should remain available. 
</Step> <Step> 

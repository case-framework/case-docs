...
- Scheduling a reminder message for intake survey
</ExampleBox>
...
<ExampleBox title="Typical use cases">
- Deleting assignment to the survey and trigger new assignments for follow-up
...
<ExampleBox title="Use Case">
Trigger sending of onboarding, invite or reminder messages.
</ExampleBox>

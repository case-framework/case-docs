...
Alternatively, you can use the Download button to save the app role template to a file and populate the form with the values from the file using the `Upload JSON` button.

...
The functionality is available only for admin users in the "User Management" module. After logging in, go to the **"User Management"** module and use the **"Available App Roles"** tab.
...
<Step>
In the "source environment": Click the `Copy` button on the right side of the app role template card.
</Step>
...
<Step>
Click Edit (pencil) in the top‑right of the app role template card to open a modal.
</Step>

<Step>

When you’re done, click "Save changes" to update the template.
</Step>

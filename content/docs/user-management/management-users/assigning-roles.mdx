...
You can assign app roles to management users to grant them specific permissions. This functionality is only available for admin users.

To get started, navigate to the **Management Users** tab and select the user you want to assign app roles to.

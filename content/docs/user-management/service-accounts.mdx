...
<Callout type="warning">
Deleting a service account will remove all its permissions and API keys from the system. This action cannot be undone. Any external services using this service account will no longer be able to authenticate.
</Callout>

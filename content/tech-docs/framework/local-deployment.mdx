...
Add all necessary variables according to the [Configuration Pattern](./configuration-pattern.mdx) article and the case-backend README file. When done, save the file.
